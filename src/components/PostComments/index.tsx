...
const Post = () => {
    ...
    return (
        <div>
            ...
            <form data-testid="Descricao" onSubmit={handleAddComment} className={styles['post-comments-form']}>
                ...
                <button data-testid="BtnAdicionar" type="submit" className={styles['post-comments-form-button']}>
                    Comentar
                </button>
            </form>
        </div>
